          ...
          petbookings.map((booking) => (
            ...
            >
              ...
              <div className="grow py-3 pr-3">
                <h2 className="md:text-2xl">{booking?.pet?.name}</h2>
                <div className="md:text-xl">
                  ...
                  <div className="md:text-xl">
                    ...
                    {/* <BookingDates
                      booking={booking}
                      className="mb-2 mt-4 hidden items-center text-black-600  md:flex"
                    /> */}
...
export default PetBookingsPage;
