...
export const Header = () => {
  ...
  return (
    <>
    <header
      className={`fixed top-0 z-10 flex w-screen justify-center  py-4 ${
        hasShadow ? 'shadow-md' : ''
      }`}
      ...
      >
        <a href="/" className="flex items-center gap-1">
          <img
            className="h-10 w-10 md:h-14 md:w-14" style={{borderRadius:'50%'}}
            src="https://static.vecteezy.com/system/resources/previews/014/431/892/large_2x/pet-store-dog-food-logo-simple-style-vector.jpg"
            alt=""
          />

          <span className="hidden text-2xl font-bold text-red-500 md:block" style={{color:'black'}}>
            Pets Shop
          </span>
        </a>
